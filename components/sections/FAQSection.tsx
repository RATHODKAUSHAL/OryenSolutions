...
const faqs = [
  {
    category: "it",
    q: "What technologies Oryensolutions specialize in for web development?",
    a: "We specialize in React, Next.js, Node.js, TypeScript, Javascript, and cloud platforms including AWS, GCP, and Vercel.",
  },
  {
    category: "bim",
...
export function FAQSection() {
  ...
  const [category, setCategory] = useState<"it" | "bim">("it");
      ...
      <div className="mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-8 flex w-fit rounded-full border border-[#7DA0CA]/40 bg-[#f8fcff] p-1">
          <button
            ...
            className={`rounded-full px-5 py-2 text-sm font-semibold transition ${category === "it" ? "bg-[#052659] text-white" : "text-slate-600 hover:text-slate-900"
              }`}
          >
            IT & Web Dev
          </button>
          <button
            ...
            className={`rounded-full px-5 py-2 text-sm font-semibold transition ${category === "bim" ? "bg-[#052659] text-white" : "text-slate-600 hover:text-slate-900"
              }`}
          >
            BIM & Tekla
          </button>
